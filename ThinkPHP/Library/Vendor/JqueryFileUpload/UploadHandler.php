...
class UploadHandler
{
    ...
    protected $error_messages = array(
        ...
        'max_number_of_files' => '文件数超过最大限制数量',
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->response = array();
        $this->options = array(
            'script_url' => "http://vsite.cc/index.php?m=vsite&c=admin&a=aj_picGroupUpload",
            'upload_dir' => $_SERVER['CONTEXT_DOCUMENT_ROOT']."/Public/Upload/jqueryfileupload/".date('Ymd').'/',
            'upload_url' => "/Public/Upload/jqueryfileupload/".date('Ymd').'/',//返回路径
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
